...
/*
* Clase que se encarga de dar autorizacion a nuestra app si el jwt es ok - OATH
* Extendemos de ResourceServerConfigurerAdapter
* Implementamos el metodo que nos permite implementar todas las reglas de seguridad de nuestros endpoint: configure(HttpSecurity http)
*
*/
    ...
    * */
    ...
    public void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests().antMatchers(HttpMethod.GET, "/api/clientes", "/api/clientes/page/**", "/api/clientes/upload/img/**", "/images/**")
                ...
                .antMatchers("/api/clientes/factura/**").permitAll()
                .anyRequest()
                .authenticated()
